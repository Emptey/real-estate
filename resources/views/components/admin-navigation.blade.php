<div class="navbar-fixed-top">
    ...
    <div class="x1-5-margin-top menu-container">
        <nav class="nav flex-column">
            ...
            <a class="{{ Route::is('get-admin-user-mgnt') || Route::is('search-user') || Route::is('add-user') || Route::is('view-user') ? 'active animate__animated animate__fadeIn animate__delay-1st' : '#' }}" href="{{ route('get-admin-user-mgnt') }}"> <i class="fa fa-users"></i> User Management </a>
