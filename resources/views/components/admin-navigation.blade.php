<div class="navbar-fixed-top">
    ...
    <div class="x1-5-margin-top menu-container">
        <nav class="nav flex-column">
            ...
            <a class="{{ Route::is('get-admin-investment') ? 'active animate__animated animate__fadeIn animate__delay-1s' : '' }}" href="{{ route('get-admin-investment') }}"> <i class="fa fa-chart-pie"></i> Investment Manager</a>
